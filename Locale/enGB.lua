local L = LibStub("AceLocale-3.0"):NewLocale("SortGroup", "enGB", true)
...
L["SortGroup_Option_Text_Template_Text"] = "Templates"
L["SortGroup_Option_btn_SetTemplate_Text"] = "Save Template"
L["SortGroup_Option_btn_LoadTemplate_Text"] = "Load Template"
L["SortGroup_Option_btn_SetTemplate_ToolTip"] = "Your current setting will be set as new template\n\nNote:\nCharacters who haven't been loaded with SortGroup yet are going to get loaded with this new template"
L["SortGroup_Option_btn_Reset_ToolTip"] = "Load setting from stored template"